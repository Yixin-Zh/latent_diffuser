...
class BaseDiffusionSDE(DiffusionModel):
    ...
    def __init__(
        ...
        super().__init__(
            nn_diffusion,fix_mask, loss_weight, grad_clip_norm,
    ...
    def update(self, x0, step, condition=None, update_ema=True, **kwargs):
        ...
        if step % 200 == 0:
            return {"step": step, "loss": loss.item(), }
        else:
            return {"step": step, "loss": 0., }
...
class ContinuousDiffusionSDE(BaseDiffusionSDE):
    ...
    def __init__(
        ...
        super().__init__(
            nn_diffusion, fix_mask, loss_weight,  grad_clip_norm, ema_rate, optim_params,
