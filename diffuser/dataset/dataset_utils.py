...
############### For Descision Diffuser ###############
# To = 16 for low-dim and 1 for high-dim
# Ta = 16
# pad_before = 0
# pad_after = 0
# img|
#  o1| o2| o3| o4|
#  a1| a2| a3| a4|
# from o1 and o2 to predict a1: inverse dynamics
...
def create_indices(
    ...
    for i in range(len(episode_ends)):
        ...
        for idx in range(min_start, max_start + 1):
            ...
            # start_offset = max(0, idx) - idx
            end_offset = (idx + sequence_length + start_idx) - buffer_end_idx
            # end_offset = (idx + sequence_length) - min(idx + sequence_length, episode_length)
            sample_start_idx = 0 + start_offset
            # sample_start_idx = max(0, idx) - idx
            sample_end_idx = sequence_length - end_offset
            # sample_end_idx = min(idx + sequence_length, episode_length) - idx
            if debug:
...
class SequenceSampler:
    def __init__(
        ...
        self.key_first_k = key_first_k # use to optimize performance
    ...
    def sample_sequence(self, idx):
        ...
        for key in self.keys:
            ...
            # if key in self.rgb_keys: # RGB image condition
            #     # pick first frame
            ...
            if (sample_start_idx > 0) or (sample_end_idx < self.sequence_length):
                ...
                if not self.zero_padding:
                    ...
                    # zero padding the pad before
                    # use last frame for pad after
